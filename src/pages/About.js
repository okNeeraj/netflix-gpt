  ...
  return (
    <div className='about-us mt-[70px] px-4 md:px-24'>
      ...
      <p className='text-gray-400 mb-8 text-center'>
        ...
        <br />
        <br />
        <a href='f' target='_blank' rel='noreferrer'>Join me</a> in the future of web development, where innovation and user-centric design converge to create NetflixGPT—a showcase of what's possible in the realm of entertainment.
      </p>
